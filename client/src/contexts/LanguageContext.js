...
export const LanguageProvider = ({ children }) => {
  ...
  const translations = {
    'zh-TW': {
      ...
      'about.hero.title': '找到您的完美財務顧問',
      'about.hero.subtitle': '透過智能配對、真實活動體驗和積分獎勵系統，建立信任關係，實現您的財務目標',
      'about.hero.cta': '立即成為會員',
      'about.hero.learnMore': '了解更多',
      'about.mission.title': '我們的使命',
      'about.mission.subtitle': '讓每個人都能找到最適合的財務顧問，建立長期信任關係',
      'about.mission.description': '我們相信財務規劃不應該是一般化的服務。每個人的財務狀況、目標和風險承受度都不同，因此需要個性化的建議和持續的支持。',
      ...
      'about.coreValues.trustDesc': '透過真實活動和面對面互動，讓您與顧問建立深厚的信任關係',
      'about.coreValues.engagement': '持續參與',
      'about.coreValues.engagementDesc': '積分系統和獎勵機制，鼓勵您積極參與財務教育活動',
      'about.coreValues.transparency': '透明管理',
      'about.coreValues.transparencyDesc': '一站式儀表板，讓您清楚掌握所有投資狀況和建議',
      ...
      'about.team.subtitle': '我們是一群充滿熱情的專業人士，致力於為您提供最好的財務規劃服務',
      ...
      'about.giftSystem.earn.quiz': '完成問卷調查',
      ...
      'about.giftSystem.featured.giftcard': 'HKD500 超市禮品卡',
    ...
    'en': {
      ...
      'about.hero.title': 'Find Your Perfect Financial Advisor',
      'about.hero.subtitle': 'Build trust through intelligent matching, real event experiences, and reward systems to achieve your financial goals',
      ...
      'about.coreValues.personalizedDesc': 'AI-driven intelligent matching system that finds the perfect financial advisor based on your specific needs and preferences',
      'about.coreValues.trust': 'Building Trust',
      'about.coreValues.trustDesc': 'Build deep trust relationships with advisors through real events and face-to-face interactions',
      'about.coreValues.engagement': 'Continuous Engagement',
      'about.coreValues.engagementDesc': 'Points system and reward mechanisms that encourage active participation in financial education activities',
      ...
      'about.team.subtitle': 'We are a group of passionate professionals dedicated to providing you with the best financial planning services',
      ...
      'about.giftSystem.featured.giftcard': 'HKD500 supermarket gift card',
