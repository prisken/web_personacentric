...
export const LanguageProvider = ({ children }) => {
  ...
  const translations = {
    'zh-TW': {
      ...
      'financialPlanning.totalMonthlyIncomeCalculation': '工作收入（僅來自強積金卡月薪）',
      'financialPlanning.totalMonthlyIncomeDescription': '僅包括工作薪資（來自強積金卡月薪，退休前），不包含其他被動收入來源',
    ...
    'en': {
      ...
      'financialPlanning.totalMonthlyIncomeCalculation': 'Work Income (only from MPF card monthly salary)',
      'financialPlanning.totalMonthlyIncomeDescription': 'Only includes work salary (from MPF card monthly salary, pre-retirement), does not include other passive income sources',
