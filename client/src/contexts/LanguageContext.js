...
export const LanguageProvider = ({ children }) => {
  ...
  const translations = {
    'zh-TW': {
      ...
      'financialPlanning.retirementIncome': '年金收入',
      ...
      'financialPlanning.passiveIncomeCalculation': '投資收益 + 租金收入 + 年金收入',
      'financialPlanning.passiveIncomeDescription': '無需工作即可獲得的收入，包括投資分紅、租金、年金等',
      ...
      'productCard.contributionPeriod': '供款年期',
      'productCard.contributionAmount': '供款額 (HKD)',
      'productCard.contributionAmountPlaceholder': '例如: 1000000',
      'productCard.gender': '性別',
      'productCard.male': '男性',
      'productCard.female': '女性',
      ...
      'productCard.contributionAmount': 'Contribution Amount (HKD)',
