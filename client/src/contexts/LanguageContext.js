...
export const LanguageProvider = ({ children }) => {
  ...
  const translations = {
    'zh-TW': {
      ...
      'foodForTalk.details.heroTitle': '🌸 活動玩法說明｜神秘日式速配派對 🌸',
      'foodForTalk.details.howToTitle': '🤩 究竟點玩？',
      'foodForTalk.details.howTo.step1': '2分鐘極速報名：一份超簡單的表格，分享興趣、專長、最吸引人之處同小小自我介紹！真名同樣貌完全唔會公開！',
      'foodForTalk.details.howTo.step2': '匿名偷窺：報完名，即可瀏覽其他參加者的匿名卡片：興趣、專長、最有魅力之處一覽無遺！',
      'foodForTalk.details.howTo.step3': '專員暗中聯絡你：主辦團隊會主動聯絡，了解你嘅想法，確保大家玩得認真又開心！',
      'foodForTalk.details.howTo.step4': '神秘聊天室熱身：成功入選可獲專屬通行碼，加入匿名聊天室，未見面已經有火花！',
      'foodForTalk.details.howTo.step5': '大日子現身！20位入選者齊聚，精緻下午茶＋現場速配遊戲！',
      ...
      'foodForTalk.details.faq.a2': '請留意 Whatsapp 或 email 通知',
