...
export const LanguageProvider = ({ children }) => {
  ...
  const translations = {
    'zh-TW': {
      ...
      // Food for Talk Event System
      'foodForTalk.title': 'Food for Talk',
      'foodForTalk.subtitle': '快速約會活動',
      'foodForTalk.eventDate': '2025年10月',
      ...
      'foodForTalk.countdown.seconds': '秒',
      'foodForTalk.countdown.untilEvent': '距離活動開始還有',
      'foodForTalk.countdown.eventStarted': '活動已開始！',
      // Event Page UI
      'foodForTalk.information': '活動資訊',
      'foodForTalk.organizer': '主辦',
      'foodForTalk.locationLabel': '場地',
      'foodForTalk.drinksLabel': '飲品',
      'foodForTalk.mediaLabel': '媒體',
      'foodForTalk.inactiveTitle': '活動未啟動',
      'foodForTalk.inactiveDesc': '活動目前未啟動，請稍後再來。',
      'foodForTalk.completedTitle': '活動已結束',
      'foodForTalk.completedDesc': '多謝參與本次 Food for Talk 活動！',
      // Event Details custom
      'foodForTalk.details.heroTitle': '🌸 活動玩法說明 🌸',
      'foodForTalk.details.howToTitle': '🤩 究竟點玩？',
      'foodForTalk.details.howTo.step1': '完成2分鐘極速報名（真名同樣貌唔會公開）建立帳戶',
      'foodForTalk.details.howTo.step2': '匿名偷窺：登入帳戶，即可瀏覽其他參加者的匿名卡片：興趣、專長、最有魅力之處一覽無遺！',
      'foodForTalk.details.howTo.step3': '專員暗中聯絡你：主辦團隊會主動聯絡，了解你嘅想法，確保你在活動內得到最大價值。',
      'foodForTalk.details.howTo.step4': '神秘聊天室熱身：成功入選可獲神秘密碼，加入匿名聊天室，預先同其他參與者擦出火花！',
      'foodForTalk.details.howTo.step5': '大日子現身！20位入選者齊聚，享用10道日式精緻下午茶小點＋現場速配遊戲正式開始！',
      'foodForTalk.details.sponsorTitle': '贊助商加持·派對升級',
      'foodForTalk.details.sponsor1': 'One Half Dessert 飲品任你飲',
      'foodForTalk.details.sponsor2': 'IPPAIKI 餐廳氣氛滿分',
      'foodForTalk.details.sponsor3': 'Persona Centric 媒體團隊影靚相（不公開真名或樣貌）',
      'foodForTalk.details.faqTitle': '💡 常見問題 Q&A',
      'foodForTalk.details.faq.q1': '一定要見樣咩？',
      'foodForTalk.details.faq.a1': '唔使！活動前全程匿名，齋靠興趣同性格搵共鳴！',
      'foodForTalk.details.faq.q2': '點知自己有冇入選？',
      'foodForTalk.details.faq.a2': '請留意 Whatsapp 或 email 通知，團隊專員會聯絡',
      'foodForTalk.details.faq.q3': '使唔使錢？',
      'foodForTalk.details.faq.a3': '確定出席活動之後，需繳付HKD$400（齋嘢食都唔止呢個錢🙌）',
      'foodForTalk.details.faq.q4': '冇揀中就當冇發生過？',
      'foodForTalk.details.faq.a4': '速配遊戲每個月都會發生，在不同的地點，玩不同的遊戲。今次唔得？機會陸續有嚟。',
      ...
      'foodForTalk.sections.quickfire': '3. 神秘快問快答',
      'foodForTalk.sections.contactInfo': '4. 聯絡方式',
      'foodForTalk.form.nickname': '暱稱（公開給其他參加者）',
      'foodForTalk.form.nicknamePlaceholder': '你的暱稱',
      'foodForTalk.form.age': '年齡',
      'foodForTalk.form.selectAge': '選擇年齡',
      'foodForTalk.form.gender': '性別',
      'foodForTalk.form.gender.male': '男',
      'foodForTalk.form.gender.female': '女',
      'foodForTalk.form.gender.other': '其他',
      'foodForTalk.form.expectPersonType': '你最期待在活動中遇到的人是哪種？',
      'foodForTalk.form.dreamFirstDate': '你最想帶對方去邊度玩？',
      'foodForTalk.form.other': '其他（請填寫）',
      'foodForTalk.form.interests': '你最愛的興趣/專長係咩？（最多選3項）',
      'foodForTalk.form.interestsOther': '其他（請填寫）',
      'foodForTalk.form.traits': '你最吸引人或最擅長的是咩？（最多選2項）',
      'foodForTalk.form.traitsOther': '其他（請填寫）',
      'foodForTalk.form.japaneseFood': '你食日式料理一定要點咩？',
      'foodForTalk.form.magicItem': '想擁有什麼超能力?',
      'foodForTalk.form.desiredOutcome': '你最想喺速配活動攞到咩？',
      'foodForTalk.form.whatsappPhone': 'Whatsapp/電話',
      'foodForTalk.form.password': '密碼',
      'foodForTalk.form.email': '電郵',
      'foodForTalk.form.bio': '自我介紹',
      'foodForTalk.form.bioPlaceholder': '簡單介紹自己（興趣、專長、理想對象…）',
      'foodForTalk.form.profilePhoto': '個人照片 (可選)',
      'foodForTalk.form.consent': '我同意讓我的暱稱、年齡、性別、興趣等資料公開俾其他入選參加者瀏覽，並同意條款及細則。',
      'foodForTalk.submit': '立即報名',

      // Registration
      'foodForTalk.register.title': '報名參加 Food for Talk',
      'foodForTalk.register.subtitle': '填寫以下信息完成報名',
      'foodForTalk.register.firstName': '名字',
      'foodForTalk.register.lastName': '姓氏',
      'foodForTalk.register.email': '電子郵件',
      'foodForTalk.register.phone': '電話號碼',
      'foodForTalk.register.age': '年齡',
      'foodForTalk.register.gender': '性別',
      'foodForTalk.register.gender.male': '男性',
      'foodForTalk.register.gender.female': '女性',
      'foodForTalk.register.gender.other': '其他',
      'foodForTalk.register.interests': '興趣愛好',
      'foodForTalk.register.bio': '個人簡介',
      'foodForTalk.register.bioPlaceholder': '簡單介紹一下自己...',
      'foodForTalk.register.profilePhoto': '個人照片',
      'foodForTalk.register.uploadPhoto': '上傳照片',
      'foodForTalk.register.password': '密碼',
      'foodForTalk.register.confirmPassword': '確認密碼',
      'foodForTalk.register.submit': '提交報名',
      'foodForTalk.register.success': '報名成功！',
      'foodForTalk.register.successMessage': '您已成功報名參加 Food for Talk 活動。我們會通過電子郵件發送更多詳情。',
      'foodForTalk.register.error': '報名失敗',
      'foodForTalk.register.errorMessage': '報名過程中出現錯誤，請重試。',

      // Login
      'foodForTalk.login.title': '登入查看參與者',
      'foodForTalk.login.subtitle': '使用您的憑證登入以查看其他參與者',
      'foodForTalk.login.email': '電子郵件',
      'foodForTalk.login.password': '密碼',
      'foodForTalk.login.submit': '登入',
      'foodForTalk.login.error': '登入失敗',
      'foodForTalk.login.errorMessage': '電子郵件或密碼不正確，請重試。',

      // Secret Login
      'foodForTalk.secretLogin.title': '進入秘密聊天室',
      'foodForTalk.secretLogin.subtitle': '輸入您的憑證和秘密通行碼',
      'foodForTalk.secretLogin.email': '電子郵件',
      'foodForTalk.secretLogin.password': '密碼',
      'foodForTalk.secretLogin.secretPasskey': '秘密通行碼',
      'foodForTalk.secretLogin.submit': '進入聊天室',
      'foodForTalk.secretLogin.error': '登入失敗',
      'foodForTalk.secretLogin.errorMessage': '憑證或秘密通行碼不正確，請重試。',

      // Participants
      'foodForTalk.participants.title': '活動參與者',
      'foodForTalk.participants.subtitle': '查看其他參與者的基本信息',
      'foodForTalk.participants.noParticipants': '暫無參與者',
      ...
      'foodForTalk.chat.subtitle': '與其他參與者匿名聊天',
      'foodForTalk.chat.publicChat': '公開聊天',
      'foodForTalk.chat.privateChat': '私聊',
      'foodForTalk.chat.participants': '參與者',
      'foodForTalk.chat.online': '在線',
      'foodForTalk.chat.startPrivateChat': '開始私聊',
      'foodForTalk.chat.viewProfile': '查看資料',
      'foodForTalk.chat.typeMessage': '輸入消息...',
      'foodForTalk.chat.typePrivateMessage': '輸入私聊消息...',
      'foodForTalk.chat.send': '發送',
      'foodForTalk.chat.noMessages': '暫無消息',
      'foodForTalk.chat.noPrivateMessages': '暫無私聊消息，開始對話吧！',
      'foodForTalk.chat.closeTab': '關閉',
      'foodForTalk.chat.profileViewed': '您已查看此用戶的資料，將被移出聊天室',
      'foodForTalk.chat.profileViewWarning': '注意：查看用戶資料後，您將被移出秘密聊天室',

      // Profile View
      'foodForTalk.profile.title': '用戶資料',
      'foodForTalk.profile.name': '姓名',
      'foodForTalk.profile.age': '年齡',
      'foodForTalk.profile.gender': '性別',
      'foodForTalk.profile.interests': '興趣愛好',
      'foodForTalk.profile.bio': '個人簡介',
      'foodForTalk.profile.close': '關閉',

      // SuperAdmin Management
      'foodForTalk.admin.title': 'Food for Talk 管理',
      'foodForTalk.admin.subtitle': '管理活動參與者',
      'foodForTalk.admin.totalParticipants': '總參與者',
      'foodForTalk.admin.activeParticipants': '活躍參與者',
      'foodForTalk.admin.totalMessages': '總消息數',
      'foodForTalk.admin.participantsTable': '參與者列表',
      'foodForTalk.admin.name': '姓名',
      'foodForTalk.admin.email': '電子郵件',
      'foodForTalk.admin.phone': '電話',
      'foodForTalk.admin.age': '年齡',
      'foodForTalk.admin.gender': '性別',
      'foodForTalk.admin.secretPasskey': '秘密通行碼',
      'foodForTalk.admin.status': '狀態',
      'foodForTalk.admin.actions': '操作',
      'foodForTalk.admin.activate': '啟用',
      'foodForTalk.admin.deactivate': '停用',
      'foodForTalk.admin.newPasskey': '新通行碼',
      'foodForTalk.admin.hasPasskey': '有通行碼',
      'foodForTalk.admin.noPasskey': '無通行碼',
      'foodForTalk.admin.active': '活躍',
      'foodForTalk.admin.inactive': '非活躍',

      // Common
      'foodForTalk.common.loading': '載入中...',
      'foodForTalk.common.error': '錯誤',
      'foodForTalk.common.success': '成功',
      'foodForTalk.common.cancel': '取消',
      'foodForTalk.common.confirm': '確認',
      'foodForTalk.common.back': '返回',
      'foodForTalk.common.close': '關閉',
      'foodForTalk.common.save': '保存',
      'foodForTalk.common.delete': '刪除',
      'foodForTalk.common.edit': '編輯',
      'foodForTalk.common.view': '查看',
      'foodForTalk.common.required': '必填',
      'foodForTalk.common.optional': '可選',

      // Event Details
      'foodForTalk.eventDetails.title': '活動詳情',
      'foodForTalk.eventDetails.dateTime': '日期和時間',
      'foodForTalk.eventDetails.location': '地點',
      'foodForTalk.eventDetails.capacity': '容量',
      'foodForTalk.eventDetails.dining': '用餐',
      'foodForTalk.eventDetails.included': '包含內容',
      'foodForTalk.eventDetails.format': '活動形式',
      'foodForTalk.eventDetails.about': '關於此活動',
      'foodForTalk.eventDetails.dateTimeValue': '2025年10月15日<br />晚上7:00 - 10:00',
      'foodForTalk.eventDetails.locationValue': '香港中環<br />大宴會廳<br />123號主街',
      'foodForTalk.eventDetails.capacityValue': '限50人參與<br />年齡25-40歲<br />專業單身人士',
      'foodForTalk.eventDetails.diningValue': '精緻3道菜晚餐<br />葡萄酒和雞尾酒服務<br />可提供飲食特殊需求',
      'foodForTalk.eventDetails.includedValue': '歡迎雞尾酒<br />快速約會環節<br />專業攝影<br />精美禮品袋',
      'foodForTalk.eventDetails.formatValue': '5分鐘對話<br />結構化輪換<br />破冰活動<br />配對交換系統',
      'foodForTalk.eventDetails.aboutText1': '加入我們獨一無二的快速約會體驗！"Food for Talk"將認識新朋友的興奮與精緻用餐的優雅完美結合。我們精心策劃的活動將成功的專業人士聚集在一個精緻的氛圍中，讓有意義的聯繫得以發展。',
      'foodForTalk.eventDetails.aboutText2': '每位參與者都有機會通過我們結構化的快速約會形式認識多個潛在配對，隨後是精緻的晚餐，您可以與那些引起您興趣的人繼續對話。我們的專業配對團隊將在現場促進聯繫，確保每個人都有一個難忘的體驗。',
    },
    'en': {
      // Lifestyle Options
      ...
      // Food for Talk Event System
      'foodForTalk.title': 'Food for Talk',
      'foodForTalk.subtitle': 'Speed Dating Event',
      'foodForTalk.eventDate': 'October 2025',
      ...
      'foodForTalk.countdown.hours': 'Hours',
      'foodForTalk.countdown.minutes': 'Minutes',
      'foodForTalk.countdown.seconds': 'Seconds',
      'foodForTalk.countdown.untilEvent': 'Until Event Starts',
      'foodForTalk.countdown.eventStarted': 'Event Has Started!',
      // Event Page UI
      'foodForTalk.information': 'Information',
      'foodForTalk.organizer': 'Organizer',
      'foodForTalk.locationLabel': 'Location',
      'foodForTalk.drinksLabel': 'Drinks',
      'foodForTalk.mediaLabel': 'Media',
      'foodForTalk.inactiveTitle': 'Event Currently Inactive',
      'foodForTalk.inactiveDesc': 'This event is currently not active. Please check back later.',
      'foodForTalk.completedTitle': 'Event Completed',
      'foodForTalk.completedDesc': 'Thank you for participating in our Food for Talk event!',
      // Event Details custom
      'foodForTalk.details.heroTitle': '🌸 How It Works | Secret Japanese Speed Dating Party 🌸',
      'foodForTalk.details.howToTitle': '🤩 How does it work?',
      'foodForTalk.details.howTo.step1': '2-minute super-fast signup: a simple form to share your interests, skills, and a short intro. Real name and appearance are NOT shown.',
      'foodForTalk.details.howTo.step2': 'Anonymous browsing: after signup, view other participants’ anonymous cards — interests, skills, and highlights.',
      'foodForTalk.details.howTo.step3': 'Organizer follow-up: our team will contact you to understand your preferences and ensure a great experience.',
      'foodForTalk.details.howTo.step4': 'Secret chat warm-up: shortlisted participants receive a passkey to join the anonymous chat room.',
      'foodForTalk.details.howTo.step5': 'Big day meetup: 20 finalists gather for elegant afternoon tea + on-site speed-dating games!',
      'foodForTalk.details.sponsorTitle': 'Sponsors — Leveling Up the Party',
      'foodForTalk.details.sponsor1': 'One Half Dessert — Drinks',
      'foodForTalk.details.sponsor2': 'IPPAIKI — Perfect ambience',
      'foodForTalk.details.sponsor3': 'Persona Centric — Media team (no real names or faces shown)',
      'foodForTalk.details.faqTitle': '💡 FAQ',
      'foodForTalk.details.faq.q1': 'Do I need to show my face?',
      'foodForTalk.details.faq.a1': 'No. It’s anonymous before the event — connect via interests and personality!',
      'foodForTalk.details.faq.q2': 'How do I know if I’m shortlisted?',
      ...
      'foodForTalk.sections.funIntro': '2. Fun Self-intro',
      'foodForTalk.sections.quickfire': '3. Quickfire Fun',
      'foodForTalk.sections.contactInfo': '4. Contact Info',
      'foodForTalk.form.nickname': 'Nickname (visible to other participants)',
      'foodForTalk.form.nicknamePlaceholder': 'Your nickname',
      'foodForTalk.form.age': 'Age',
      'foodForTalk.form.selectAge': 'Select age',
      'foodForTalk.form.gender': 'Gender',
      'foodForTalk.form.gender.male': 'Male',
      'foodForTalk.form.gender.female': 'Female',
      'foodForTalk.form.gender.other': 'Others',
      'foodForTalk.form.expectPersonType': 'What kind of person do you hope to meet?',
      'foodForTalk.form.dreamFirstDate': 'Your dream first date?',
      'foodForTalk.form.other': 'Other (please specify)',
      'foodForTalk.form.interests': 'Your interests/skills (pick up to 3)',
      'foodForTalk.form.interestsOther': 'Other (please specify)',
      'foodForTalk.form.traits': 'What are your most attractive traits? (pick up to 2)',
      'foodForTalk.form.traitsOther': 'Other (please specify)',
      'foodForTalk.form.japaneseFood': 'What must-order Japanese dish?',
      'foodForTalk.form.magicItem': 'What superpower would you like to have?',
      'foodForTalk.form.desiredOutcome': 'What do you want to get from the event?',
      'foodForTalk.form.whatsappPhone': 'Whatsapp/Phone',
      'foodForTalk.form.password': 'Password',
      'foodForTalk.form.email': 'Email',
      ...
      'foodForTalk.form.profilePhoto': 'Profile Photo (Optional)',
      ...
      // Registration
      'foodForTalk.register.title': 'Register for Food for Talk',
      'foodForTalk.register.subtitle': 'Fill in the information below to complete registration',
      'foodForTalk.register.firstName': 'First Name',
      'foodForTalk.register.lastName': 'Last Name',
      'foodForTalk.register.email': 'Email',
      'foodForTalk.register.phone': 'Phone Number',
      'foodForTalk.register.age': 'Age',
      'foodForTalk.register.gender': 'Gender',
      'foodForTalk.register.gender.male': 'Male',
      'foodForTalk.register.gender.female': 'Female',
      'foodForTalk.register.gender.other': 'Other',
      'foodForTalk.register.interests': 'Interests',
      'foodForTalk.register.bio': 'Bio',
      'foodForTalk.register.bioPlaceholder': 'Tell us a bit about yourself...',
      'foodForTalk.register.profilePhoto': 'Profile Photo',
      'foodForTalk.register.uploadPhoto': 'Upload Photo',
      'foodForTalk.register.password': 'Password',
      'foodForTalk.register.confirmPassword': 'Confirm Password',
      'foodForTalk.register.submit': 'Submit Registration',
      'foodForTalk.register.success': 'Registration Successful!',
      'foodForTalk.register.successMessage': 'You have successfully registered for the Food for Talk event. We will send more details via email.',
      'foodForTalk.register.error': 'Registration Failed',
      'foodForTalk.register.errorMessage': 'An error occurred during registration, please try again.',

      // Login
      'foodForTalk.login.title': 'Login to View Participants',
      'foodForTalk.login.subtitle': 'Use your credentials to login and view other participants',
      'foodForTalk.login.email': 'Email',
      'foodForTalk.login.password': 'Password',
      'foodForTalk.login.submit': 'Login',
      'foodForTalk.login.error': 'Login Failed',
      'foodForTalk.login.errorMessage': 'Email or password is incorrect, please try again.',

      // Secret Login
      'foodForTalk.secretLogin.title': 'Enter Secret Chat Room',
      'foodForTalk.secretLogin.subtitle': 'Enter your credentials and secret passkey',
      'foodForTalk.secretLogin.email': 'Email',
      'foodForTalk.secretLogin.password': 'Password',
      'foodForTalk.secretLogin.secretPasskey': 'Secret Passkey',
      'foodForTalk.secretLogin.submit': 'Enter Chat Room',
      'foodForTalk.secretLogin.error': 'Login Failed',
      'foodForTalk.secretLogin.errorMessage': 'Credentials or secret passkey is incorrect, please try again.',

      // Participants
      'foodForTalk.participants.title': 'Event Participants',
      'foodForTalk.participants.subtitle': 'View basic information of other participants',
      'foodForTalk.participants.noParticipants': 'No participants yet',
      ...
      'foodForTalk.chat.subtitle': 'Chat anonymously with other participants',
      'foodForTalk.chat.publicChat': 'Public Chat',
      'foodForTalk.chat.privateChat': 'Private Chat',
      'foodForTalk.chat.participants': 'Participants',
      'foodForTalk.chat.online': 'Online',
      'foodForTalk.chat.startPrivateChat': 'Start Private Chat',
      'foodForTalk.chat.viewProfile': 'View Profile',
      'foodForTalk.chat.typeMessage': 'Type your message...',
      'foodForTalk.chat.typePrivateMessage': 'Type your private message...',
      'foodForTalk.chat.send': 'Send',
      'foodForTalk.chat.noMessages': 'No messages yet',
      'foodForTalk.chat.noPrivateMessages': 'No private messages yet, start the conversation!',
      'foodForTalk.chat.closeTab': 'Close',
      'foodForTalk.chat.profileViewed': 'You have viewed this user\'s profile and will be removed from the chat room',
      'foodForTalk.chat.profileViewWarning': 'Warning: After viewing a user\'s profile, you will be removed from the secret chat room',

      // Profile View
      'foodForTalk.profile.title': 'User Profile',
      'foodForTalk.profile.name': 'Name',
      'foodForTalk.profile.age': 'Age',
      'foodForTalk.profile.gender': 'Gender',
      'foodForTalk.profile.interests': 'Interests',
      'foodForTalk.profile.bio': 'Bio',
      'foodForTalk.profile.close': 'Close',

      // SuperAdmin Management
      'foodForTalk.admin.title': 'Food for Talk Management',
      'foodForTalk.admin.subtitle': 'Manage event participants',
      'foodForTalk.admin.totalParticipants': 'Total Participants',
      'foodForTalk.admin.activeParticipants': 'Active Participants',
      'foodForTalk.admin.totalMessages': 'Total Messages',
      'foodForTalk.admin.participantsTable': 'Participants List',
      'foodForTalk.admin.name': 'Name',
      'foodForTalk.admin.email': 'Email',
      'foodForTalk.admin.phone': 'Phone',
      'foodForTalk.admin.age': 'Age',
      'foodForTalk.admin.gender': 'Gender',
      'foodForTalk.admin.secretPasskey': 'Secret Passkey',
      'foodForTalk.admin.status': 'Status',
      'foodForTalk.admin.actions': 'Actions',
      'foodForTalk.admin.activate': 'Activate',
      'foodForTalk.admin.deactivate': 'Deactivate',
      'foodForTalk.admin.newPasskey': 'New Passkey',
      'foodForTalk.admin.hasPasskey': 'Has Passkey',
      'foodForTalk.admin.noPasskey': 'No Passkey',
      'foodForTalk.admin.active': 'Active',
      'foodForTalk.admin.inactive': 'Inactive',

      // Common
      'foodForTalk.common.loading': 'Loading...',
      'foodForTalk.common.error': 'Error',
      'foodForTalk.common.success': 'Success',
      'foodForTalk.common.cancel': 'Cancel',
      'foodForTalk.common.confirm': 'Confirm',
      'foodForTalk.common.back': 'Back',
      'foodForTalk.common.close': 'Close',
      'foodForTalk.common.save': 'Save',
      'foodForTalk.common.delete': 'Delete',
      'foodForTalk.common.edit': 'Edit',
      'foodForTalk.common.view': 'View',
      'foodForTalk.common.required': 'Required',
      'foodForTalk.common.optional': 'Optional',

      // Event Details
      'foodForTalk.eventDetails.title': 'Event Details',
      'foodForTalk.eventDetails.dateTime': 'Date & Time',
      'foodForTalk.eventDetails.location': 'Location',
      'foodForTalk.eventDetails.capacity': 'Capacity',
      'foodForTalk.eventDetails.dining': 'Dining',
      'foodForTalk.eventDetails.included': 'What\'s Included',
      'foodForTalk.eventDetails.format': 'Format',
      'foodForTalk.eventDetails.about': 'About This Event',
      'foodForTalk.eventDetails.dateTimeValue': 'Saturday, October 15th, 2025<br />7:00 PM - 10:00 PM',
      'foodForTalk.eventDetails.locationValue': 'The Grand Ballroom<br />123 Main Street<br />Central Hong Kong',
      'foodForTalk.eventDetails.capacityValue': 'Limited to 50 participants<br />Ages 25-40<br />Professional singles',
      'foodForTalk.eventDetails.diningValue': 'Gourmet 3-course dinner<br />Wine & cocktail service<br />Dietary accommodations available',
      'foodForTalk.eventDetails.includedValue': 'Welcome cocktail<br />Speed dating sessions<br />Professional photography<br />Goodie bag',
      'foodForTalk.eventDetails.formatValue': '5-minute conversations<br />Structured rotation<br />Ice-breaker activities<br />Match exchange system',
      'foodForTalk.eventDetails.aboutText1': 'Join us for an exclusive speed dating experience like no other! "Food for Talk" combines the excitement of meeting new people with the elegance of fine dining. Our carefully curated event brings together successful professionals in a sophisticated atmosphere where meaningful connections can flourish.',
      'foodForTalk.eventDetails.aboutText2': 'Each participant will have the opportunity to meet multiple potential matches through our structured speed dating format, followed by an elegant dinner where you can continue conversations with those who caught your interest. Our professional matchmaking team will be on hand to facilitate connections and ensure everyone has a memorable experience.',
    }
  };
