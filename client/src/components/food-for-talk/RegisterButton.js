...
const RegisterButton = () => {
  ...
  return (
    <Link
      ...
      className="group relative inline-flex items-center w-full sm:w-auto px-8 py-4 rounded-2xl font-extrabold text-white text-lg sm:text-xl transition-all duration-300 transform hover:scale-105 shadow-lg"
      style={{
