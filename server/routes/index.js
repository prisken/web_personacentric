...
const foodForTalkAgentRoutes = require('./foodForTalkAgent');
const databaseFixRoutes = require('./databaseFix');
...
router.use('/food-for-talk/agent', foodForTalkAgentRoutes);
router.use('/db-fix', databaseFixRoutes);
