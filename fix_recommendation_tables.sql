...
DROP TABLE IF EXISTS recommendation_engagements CASCADE;
...
-- Create recommendations table with correct schema
...
-- Create recommendation_engagements table with correct schema
